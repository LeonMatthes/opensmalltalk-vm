/* Automatically generated by
	VMPluginCodeGenerator * VMMaker.threaded-LM.3356 uuid: bc5d6545-faa3-4e8e-8b64-8bd3c8ee48fe
   from
	FilePlugin * VMMaker.threaded-LM.3356 uuid: bc5d6545-faa3-4e8e-8b64-8bd3c8ee48fe
 */
static char __buildInfo[] = "FilePlugin * VMMaker.threaded-LM.3356 uuid: bc5d6545-faa3-4e8e-8b64-8bd3c8ee48fe " __DATE__ ;
...
EXPORT(sqInt) primitiveSuspend(void);
EXPORT(sqInt) primitiveTestDisown(void);
...
static const char *moduleName = "FilePlugin * VMMaker.threaded-LM.3356 " INT_EXT;
static void * sCCPfn;
static void * sCDFfn;
static void * sCDPfn;
static void * sCGFTfn;
...
primitiveHasFileAccess(void)
{
	...
	/* FilePlugin>>#primitiveSuspend */
EXPORT(sqInt)
primitiveSuspend(void)
{
    sqInt disown;
    sqIntptr_t sleepDuration;
    void *vmHandle;

	vmHandle = ((void *) 0);
	sleepDuration = positiveMachineIntegerValueOf(stackValue(1));
	disown = booleanValueOf(stackValue(0));
	if (failed()) {
		return 0;
	}
	if (disown) {
	...
	/* FilePlugin>>#primitiveTestDisown */
EXPORT(sqInt)
primitiveTestDisown(void)
{
    sqInt disown;
    void *vmHandle;
...
void* FilePlugin_exports[][3] = {
	...
	{(void*)_m, "primitiveSuspend\000\000\000", (void*)primitiveSuspend},
	{(void*)_m, "primitiveTestDisown\000\000\000", (void*)primitiveTestDisown},
...
EXPORT(signed short) primitiveSuspendMetadata = 0;
EXPORT(signed short) primitiveTestDisownMetadata = 0;
#endif // SPURVM
