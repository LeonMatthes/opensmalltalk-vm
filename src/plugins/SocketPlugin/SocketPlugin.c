/* Automatically generated by
	SmartSyntaxPluginCodeGenerator * VMMaker.threaded-LM.3352 uuid: 549d31a1-9ae0-4620-923d-af4ea62dff9c
   from
	SocketPlugin * VMMaker.threaded-LM.3352 uuid: 549d31a1-9ae0-4620-923d-af4ea62dff9c
 */
static char __buildInfo[] = "SocketPlugin * VMMaker.threaded-LM.3352 uuid: 549d31a1-9ae0-4620-923d-af4ea62dff9c " __DATE__ ;
...
static const char *moduleName = "SocketPlugin * VMMaker.threaded-LM.3352 " INT_EXT;
...
primitiveSocketCloseConnection(void)
{
	...
	if (!(failed())) {
		sqSocketCloseConnectionisPinned(s, isPinned(socket));
	}
	if (!(failed())) {
		pop(1);
	}
