/* Automatically generated by
   ...
   from
	SqueakSSLPlugin * VMMaker.threaded-LM.3356 uuid: bc5d6545-faa3-4e8e-8b64-8bd3c8ee48fe
 */
static char __buildInfo[] = "SqueakSSLPlugin * VMMaker.threaded-LM.3356 uuid: bc5d6545-faa3-4e8e-8b64-8bd3c8ee48fe " __DATE__ ;
...
static const char *moduleName = "SqueakSSL * VMMaker.threaded-LM.3356 " INT_EXT;
...
primitiveConnect(void)
{
	...
	if (canDisown) {
		...
		warning("SqueakSSL>>#primitiveConnect cannot disown, an argument isn't pinned.");
	}
